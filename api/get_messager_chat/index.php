...
$results = $db->select('SELECT * FROM chats WHERE (to_user_id = :to_user_id AND user_id = :user_id) OR (to_user_id = :user_id AND user_id = :to_user_id) LIMIT 200 OFFSET 0', $params);
